...
protected:
    ...
    virtual void calculate_entropy(const arma::mat & cov_mat, int n) =0;
public:
...
protected:
    ...
    virtual void calculate_entropy(double, int) =0;
public:
...
private:
    ...
    void calculate_entropy(const arma::mat & cov_mat, int n);
...
private:
    void calculate_entropy(double, int);
    double m_r;
public:
